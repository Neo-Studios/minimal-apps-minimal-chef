...
- **Galaxy Z Flip5** with One UI 6.1+ (SM-F731)
- **Galaxy Tab S9 series** (SM-X91x)
- **Requirements**: One UI 6.1+ (Android 14+)
...
- **Redmi K70 series**
- **Requirements**: HyperOS (Android 14+)
...
- **Requirements**: ColorOS 14+ (Android 14+)
...
- **OnePlus Open**
- **Requirements**: OxygenOS 14+ (Android 14+)
...
- **AI Provider**: Qualcomm AI Engine
...
- **iPad Air** with M1 chip or later
- **Requirements**: iOS 18+ or iPadOS 18+
...
- Other manufacturers' on-device AI solutions
